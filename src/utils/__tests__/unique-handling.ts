...
test('grouping, filtering and requesting unique, chunked elements', async t => {
    ...
    let expectedResult = [0, 1.5, 1, 2.5, 2, 3.5, 3, 4.5, 4, 5.5, undefined, undefined, undefined, 5.5, 4, 4.5, 3, 3.5, 2, 2.5, 1, 1.5, 0];
...
test('grouping and requesting unique elements', async t => {
    ...
    let requestedValuesTemplate = [[0, 2, 4, 6, 8, 10], [1, 3, 5, 7, 9, 11]];
    let requestedValues = [];

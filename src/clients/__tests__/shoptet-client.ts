...
function nocks(companyId: ObjectId, order: ApiOrder, environment: Environment) {
    ...
    nock(environment.SHOPTET_SERVICE_URL, { 'encodedQueryParams': true })
        .post(`/company/${companyId.toHexString()}/orders`, {
            'orders': [{
                'companyId': order.companyId.toHexString(), 'marketplace': 'amazon_uk', 'marketplaceOrderId': '000000',
                'lastChanged': '2019-01-01T12:00:00.000Z', 'buyer': {
                    ...
                    'stateOrRegion': 'Praha', 'email': 'vojta@expan.do',
                }, 'currencyCode': 'EUR', 'items': [], 'fulfillmentChannel': 'FBA', 'status': 'Shipped',
                'totalPrice': 500, 'totalItemTax': 0, 'paymentMethod': 'Other', 'purchaseDate': '2019-01-01T11:00:00.000Z',
                'shipServiceLevel': 'expedited', 'isBusinessOrder': false, 'isComplete': false, 'invoiceUrls': [],
                'isPremiumOrder': false, 'isPrime': false,
            }],
        })
